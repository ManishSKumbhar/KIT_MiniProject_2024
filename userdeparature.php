...
<body>
    <div class="header">
        <?php
            ...
            $query = "SELECT * FROM departure ORDER BY id DESC LIMIT 1";
            ...
            if($result->num_rows > 0){
                while($row = $result->fetch_assoc()){
                    ...
                    echo $row["tno"];
                    echo " will depart from platform number ";
                    echo $row["pno"];
                    echo " at ";
                    echo $row["time"];
                    echo "</h2";    
...
if($language == "Marathi"){
                ...
                curl_setopt_array($curl, [
                    ...
                    CURLOPT_POSTFIELDS => json_encode([
                        'text' => "{$tname}  with train number {$tno} will depart from platform nunmber {$pno}  at {$time}.",
                        'source' => 'en',
                        'target' => 'mr'
                    ]),
