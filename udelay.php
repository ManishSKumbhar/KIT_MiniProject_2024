<?php
    ...
    $webpage_home = array("Date", "Train Name", "Train Number", "Serial Number", "Train", "Delay", "Details", 
                    "Original Time", "Delay Time (Minutes)" );
...
<body>
    <form>
        <header>
            <div class="head">
                <?php
                echo"<h2 id='headline'>$translation_home[4] &nbsp $translation_home[5] &nbsp $translation_home[6]</h2>";
                ?>
            </div>
        </header>
        ...
        <div class="tb">
            <table>
                ...
                echo"<tr>
                        ...
                        <th>$translation_home[7]</th>
                        <th>$translation_home[8]</th>
                    </tr>";
                ?>
                    <?php
                        include("connection.php");
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>" . $row['oritime'] . "</td>";  // Replace 'Delay time' with actual column name
                    echo "<td>" . $row['delay_t'] . "</td>";  // Replace 'Original Time' with actual column name
                    echo "</tr>";
