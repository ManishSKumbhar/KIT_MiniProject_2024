...
<head>
    ...
    <link rel="stylesheet" href="deparature.css">
</head>
<body>
    <div class="wrap">
        <form action="deparature.php">
                ...
                <div class="input-box" id="cid">
                    <i>
                        <input type="number" placeholder="Incremental id" name = "id" required class="one">
                    </i>
                </div>
...
$query3 = "INSERT INTO departure VALUES ('$tname', '$tno', '$pno', '$id','$time')";
